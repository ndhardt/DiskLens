...
const ja: Record<Key, string> = {
  ...
  "empty.pressScan": "ボリュームを選んでスキャンを押してください",
  ...
  "status.selected": "選択中",
  "status.noScan": "未スキャン",
  "status.scanning": "スキャン中 {path} — {size} 解析済み",
  "status.completed": "スキャン完了 {t}",
  "status.stopped": "スキャン中止 {t}",
  ...
  "menu.open": "開く",
  "menu.quickLook": "クイックルック",
  "menu.reveal": "Finder で表示",
  ...
  "set.spotlightHint":
    "スキャン後、大きい方から {n} 件について kMDItemLastUsedDate を取得します。無効の場合、未使用期間はファイルシステムのアクセス日時にフォールバックします。",
  ...
  "set.fda": "フルディスクアクセス",
  "set.fdaGranted": "許可済み。読み取り可能なすべてのフォルダをスキャンします。",
  "set.fdaMissingN": "未許可。前回のスキャンで {n} 個のフォルダをスキップしました。",
  "set.fdaMissing": "未許可。一部のフォルダはスキップされます。",
  "set.openSettings": "設定を開く",
  "set.scannerUsed": "前回のスキャンでは {name} スキャナを使用しました。",
