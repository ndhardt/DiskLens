...
const en = {
  ...
  "clean.caption": "CLEANUP",
  "clean.safeTotal": "{size} safe to reclaim",
  "clean.selected": "{n} selected · {size}",
  "clean.run": "Move to Trash",
  "clean.running": "Moving…",
  "clean.nothing": "Nothing to clean up",
  "clean.nothingHint": "No caches or long-unused files were found on this volume.",
  "clean.pickGroup": "Select a row to see what it contains",
  "clean.safe": "Regenerated",
  "clean.review": "Review",
  "clean.safeHint": "Regenerated by the app that wrote it. Selected by default.",
  "clean.reviewHint": "Your own files. Never selected automatically.",
  "clean.truncated": "showing the largest {n}",
  "clean.col.group": "Item",
  "clean.col.what": "Contents",
  "clean.col.entries": "Entries",
  "clean.col.files": "Files",
  "clean.col.size": "Size",
  "clean.col.kind": "Type",
  "clean.xcode": "Xcode build data",
  "clean.xcode.desc": "DerivedData, device support, simulator caches",
  "clean.packageManagers": "Package manager caches",
  "clean.packageManagers.desc": "npm, yarn, pnpm, cargo, pip, Homebrew, Gradle",
  "clean.appCaches": "Application caches",
  "clean.appCaches.desc": "~/Library/Caches",
  "clean.logs": "Logs",
  "clean.logs.desc": "~/Library/Logs",
  "clean.largeUnused": "Large and long unused",
  "clean.largeUnused.desc": "5 GB or more, untouched for over a year",
  "clean.oldDownloads": "Old downloads",
  "clean.oldDownloads.desc": "~/Downloads, untouched for over six months",
  "clean.installers": "Installers",
  "clean.installers.desc": ".dmg .pkg .xip .iso, untouched for over three months",
...
const ja: Record<Key, string> = {
  ...
  "mode.hogs": "容量ランキング",
  "mode.types": "ファイル種別",
  "mode.cleanup": "クリーンアップ",
  "clean.caption": "クリーンアップ",
  "clean.safeTotal": "安全に {size} 回収できます",
  "clean.selected": "{n} 件選択 · {size}",
  "clean.run": "ゴミ箱に入れる",
  "clean.running": "移動中…",
  "clean.nothing": "削除できるものはありません",
  "clean.nothingHint": "このボリュームにキャッシュや長期間未使用のファイルは見つかりませんでした。",
  "clean.pickGroup": "行を選ぶと中身が表示されます",
  "clean.safe": "再生成される",
  "clean.review": "要確認",
  "clean.safeHint": "書き込んだアプリが再生成します。既定で選択されます。",
  "clean.reviewHint": "あなた自身のファイルです。自動では選択しません。",
  "clean.truncated": "大きい方から {n} 件を表示",
  "clean.col.group": "項目",
  "clean.col.what": "内容",
  "clean.col.entries": "エントリ",
  "clean.col.files": "ファイル",
  "clean.col.size": "サイズ",
  "clean.col.kind": "種別",
  "clean.xcode": "Xcode のビルドデータ",
  "clean.xcode.desc": "DerivedData、DeviceSupport、Simulator キャッシュ",
  "clean.packageManagers": "パッケージマネージャのキャッシュ",
  "clean.packageManagers.desc": "npm, yarn, pnpm, cargo, pip, Homebrew, Gradle",
  "clean.appCaches": "アプリのキャッシュ",
  "clean.appCaches.desc": "~/Library/Caches",
  "clean.logs": "ログ",
  "clean.logs.desc": "~/Library/Logs",
  "clean.largeUnused": "大容量かつ長期間未使用",
  "clean.largeUnused.desc": "5 GB 以上、1年以上未使用",
  "clean.oldDownloads": "古いダウンロード",
  "clean.oldDownloads.desc": "~/Downloads、6か月以上未使用",
  "clean.installers": "インストーラ",
  "clean.installers.desc": ".dmg .pkg .xip .iso、3か月以上未使用",
  "tree.expand": "{n}階層展開",
  "tree.collapse": "折りたたむ",
  "treemap.show": "Treemap",
